<template>
  <v-card>
    <template #title> <h5>Computed 연계</h5> </template>
    <template #subtitle> Check Box의 경우도 Radio Box와 동일하게 event 객체의 value 값으로 Click 시 현재 입력된 value 값을 확인할 수 있다. </template>
    <template #text>
      <UCheckGroupBox
