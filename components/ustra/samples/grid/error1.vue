<template>
  <v-card>
    <template #title> 이벤트 기반 유효성 검사 </template>
    <template #subtitle>
      cellEditEnding 이벤트를 활용하고, cancel, stayInEditMode 옵션을 활용하여 맞지않은 값을 입력하였을때 정지 후 알림처리</template
    >
    <template #text>
      ...
      <UMarkdownViewer>{{ error1 }}</UMarkdownViewer>
    </template>
  </v-card>
</template>
...
import error1 from './md/error1.md'
